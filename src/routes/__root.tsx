...
import { NO_FLASH_THEME_SCRIPT, ThemeProvider } from "@/hooks/use-theme";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Resultados S/A — Inteligência Financeira Gerencial" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Resultados S/A — Inteligência Financeira Gerencial" },
      {
        ...
        content: "De arquivo financeiro a DRE validada, sem planilhas manuais.",
      },
